...
export const jobController = new Hono()
  ...
  .post(
    ...
    describeRoute({
      ...
      description:
        "Mencari user yang belum melakukan reflection di hari yang ditentukan dan membuat reflection trigger untuk mereka.",
    }),
    async (c) => {
  ...
  .post(
    ...
    describeRoute({
      ...
      description:
        "Mengirim notifikasi WhatsApp untuk quest yang pending (belum selesai) dan deadline-nya dalam 2 jam terakhir.",
    }),
    async (c) => {
  ...
  .post(
    ...
    describeRoute({
      ...
      description:
        "Mengirim notifikasi untuk quest yang gagal (failed) dan deadline-nya sudah lewat.",
    }),
    async (c) => {
